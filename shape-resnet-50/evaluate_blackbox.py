"""Evaluate cache models with Shape-ResNet-50 backbone on black-box adversarial images
"""
import argparse
...
parser = argparse.ArgumentParser(description='Evaluate cache models with Shape-ResNet-50 backbone on blackbox images')
parser.add_argument('--blackbox_data_dir', type=str, help='directory where blackbox adversarial images are stored')
...
np.savez('cache_blackbox_accuracy_' + eps_str + '_layer%i_theta%2.f.npz' % (which_layer, theta),
